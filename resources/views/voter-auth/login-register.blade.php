    ...
    <div id="authPage" class="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div class="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-xl">
        <div class="text-center">
          ...
          <p class="mt-2 text-sm text-gray-600">Student Government Elections 2026</p>
        ...
        <div id="loginForm" class="space-y-6">
          <div>
            ...
            <input type="text" id="loginAdmission" placeholder="e.g., IUEA-2026-1234" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-[#8B0000] focus:border-[#8B0000]">
          </div>
          <div>
        ...
        <div id="registerForm" class="space-y-6 hidden">
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">Admission Number *</label>
            <input type="text" id="regAdmission" placeholder="e.g., IUEA-2026-1234" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-[#8B0000] focus:border-[#8B0000]">
