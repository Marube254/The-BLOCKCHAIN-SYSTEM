...
<head>
    ...
    <title>Forgot Password - IUEA Voting System</title>
            ...
            <div class="col-md-5">
                <div class="card p-4">
                    <div class="text-center">
                        ...
                        <h3 class="mb-2" style="color: #8B0000;">Reset Password</h3>
                    ...
                    <form method="POST" action="{{ url('/admin/forgot-password') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" name="email" class="form-control" placeholder="admin@iuea.ac.ug" required>
                            </div>
                        </div>
